...
<div class="category-listing <% if $MultipleOf(2) || $isSecond %>second<% end_if %> <% if $MultipleOf(3) || $isThird %>third<% end_if %>">
	<div class="category-image">
        <img src="$Photo.CroppedImage(300,225).URL" alt="$Title1" title="$Title1" />
