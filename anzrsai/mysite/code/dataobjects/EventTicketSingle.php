...
class EventTicketSingle extends DataObject {
...
// 		));
		...
		$fields->addFieldToTab('Root.Main', TextField::create('MemberPrice', 'Price ( per day )'));
// 		$fields->addFieldToTab('Root.Main', TextField::create('NonMemberPrice', 'Non-member Price ( per day )'));
