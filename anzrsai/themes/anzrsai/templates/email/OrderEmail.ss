                                ...
                                <tbody>
                                    <% loop $Membership %>
                                        ...
                                        <tr style="background-color: #f0f0f0;">
                                            <td style="border: 1px solid #dddddd; border-collapse:collapse; color: #484848; padding-left: 5px;" ><strong>$Type</strong>
                                            <br>
                                            Expiry Date - $ExpiryDate</td>
                                            <td style="border: 1px solid #dddddd; border-collapse:collapse; color: #484848; padding-left: 5px;">$$Price AUD</td>
                                            <td style="border: 1px solid #dddddd; border-collapse:collapse; color: #484848; text-align:center;">1</td>
                                            <td style="border: 1px solid #dddddd; border-collapse:collapse; color: #484848; font-weight: bold; text-align: center;">$$Price AUD</td>
                                        </tr>
                                    <% end_loop %>
                                </tbody>
                            </table>
